...
import FluidBackground from '../../components/Cursor-Fluid-Background'
...
const description= "Lorem ipsum dolor sit amet consectetur adipisicing elit. A, et. Saepe ex ad, voluptates nisi enim tempora tempore dignissimos placeat fugiat, consequuntur, unde dolor?"
const page = () => {  
  return (
    <>
    <FluidBackground images={images} text={text} description={description} />
    <Widget />
    <FunMission/>
    </>
  )
